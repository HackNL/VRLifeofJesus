VR.render = (function () { //funtion to render a template.
  ...
  function gotoSection(sectionName){
  	if(sectionName == 'video-meta'){
  		document.getElementsByClassName('video-meta')[0].style.display = 'block';
  		document.getElementsByClassName('timeline')[0].style.display = 'none';
  		setActiveSection('video-meta');
  		clickMetaVideo();
  	}else if( sectionName == "timeline"){
  		document.getElementsByClassName('timeline')[0].style.display = 'block';
  		document.getElementsByClassName('video-meta')[0].style.display = 'none';
  	}
  }
